...
import { getShadersForMaterial } from '../troika-three-utils/getShadersForMaterial'
...
export class InstancedUniformsMesh extends InstancedMesh {
  ...
  get geometry () {
    ...
    if (!derivedGeom || derivedGeom.baseGeometry !== baseGeom) {
      ...
      /* For some reason this adds listener to derived geometry aswell, so it leads to infinite loop
